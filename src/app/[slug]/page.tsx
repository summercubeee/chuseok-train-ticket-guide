  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <div className="mb-8 rounded-2xl border border-amber-200 bg-amber-50 p-5 text-sm leading-relaxed text-zinc-700 dark:border-amber-900/40 dark:bg-amber-950/20 dark:text-zinc-300">
        <p className="mb-2 font-semibold text-amber-700 dark:text-amber-400">공식 출처 기반 답변</p>
        <p>{q.intro}</p>
      </div>
      ...
      <Link href="/questions" className="mt-10 inline-block text-sm text-zinc-500 hover:text-amber-600">
        ← 다들 궁금해하는 질문 전체 보기
      </Link>
    </div>
  );
